...
class ElonMuskMultimedia extends StatefulWidget {
  ElonMuskMultimedia({Key? key}) : super(key: key);

  @override
  State<ElonMuskMultimedia> createState() => _ElonMuskMultimediaState();
}

class _ElonMuskMultimediaState extends State<ElonMuskMultimedia> {
  bool isLiked = false;
  int likeCount = 10;
